...
var code = void 0;
var client_id = void 0;
var client_secret = void 0;
var access_token = void 0;
var refresh_token = void 0;
var agentId = void 0;
...
function promiseToGet(ops) {
    ...
    (0, _requestPromise2.default)(ops).then(function (thejson) {
        return new Promise(function (resolve, reject) {
            setTimeout(function () {
                return resolve(thejson);
            }, 2500);
        }) //2.5  seconds
        .catch(function (err) {
            return console.log("error: " + " " + JSON.stringify(thejson), err.message);
        });
...
var SparkApiAuth = function () {
    _createClass(SparkApiAuth, [{
        key: 'reqargs',
        get: function get() {
    ...
    function SparkApiAuth() {
        _classCallCheck(this, SparkApiAuth);
    ...
    _createClass(SparkApiAuth, [{
        key: 'saveTokens',
        value: function saveTokens(newAToken, newRToken, newExpires, newAgentId, newcode, res) {
        ...
        key: 'promiseSaveListings',
        value: function promiseSaveListings(listings) {
            ...
            .then(function (listings) {
                listings.forEach(function (listing) {
                    ...
                    // })
                    if (uplist['Photos'][0]) {
                        var _saving = uplist['Photos'].forEach(function (key) {
                            Object.keys(uplist['Photos'][0]).forEach(function (subkey) {
        ...
        value: function getListings(req, res, filter) {
            ...
            var opsurl = this.makeUrl(setargs, null, 'A', 'https://sparkapi.com/v1/listings?', 'Active');
            var authops = {
                headers: this.oauthHeaders(),
                uri: opsurl + '&_pagination=count&_page=1',
                json: true
            };
            var od = Object.assign({}, oauthData);
            var fdB = this.fBdB;
            var tauth = new SparkApiAuth(fdB);
            var rt;
            rt = function rt() {
        ...
        key: 'promiseTo',
        value: function promiseTo(doThis) {
        ...
        key: 'countPromise',
        value: function countPromise(at, args) {
            var zip = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : null;
            var proptype = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : null;
        ...
        value: function refreshAuth() {
            var oauthData = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : oauthData;
            var auth = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : null;

            var thisauth = Object.assign(auth, this);
        ...
        value: function countPagesAndRequestJson(at, fbd) {
            ...
            var countArgs = Object.assign({}, setargs);
            countArgs._pagination = 'count';
            var countOps = this.setupOptions({
                at: at,
                args: countArgs,
                listId: null,
                page: zip,
            ...
            var oauthData = Object.assign({}, oauthData);
            var fBdB = this.fBdB;
            var auth = this;
            var rt = void 0;
            rt = function rt() {
            ...
            (0, _requestPromise2.default)(countOps).then(function (response) {
                var pages = response.D.Pagination.TotalPages;
                for (var page = 1; page <= pages; page++) {
                    var pageReq = {};
...
exports.default = SparkApiAuth;
//# sourceMappingURL=sparkapiauth.js.map